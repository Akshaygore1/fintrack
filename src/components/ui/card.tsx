  ...
  "overflow-hidden text-sm group/card flex flex-col transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass:
          "bg-card/60 backdrop-blur-xl text-card-foreground ring-1 ring-white/5",
        elevated:
          "bg-card text-card-foreground shadow-lg shadow-black/10 ring-1 ring-border/30",
      ...
      size: {
        default:
          "gap-4 py-4 has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0",
